/**
 * Sync Script for Better Upload
 *
 * From `https://better-upload.com/r` Get all components and save them locally
 * Responsibility: Purely download, keep the source data as is
 *
 * Usage:
 *   bun run registries/better-upload/scripts/sync.ts
 *   bun run registries/better-upload/scripts/sync.ts --only=upload-button
 *   bun run registries/better-upload/scripts/sync.ts --dry-run
 */
