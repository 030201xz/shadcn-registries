/**
 * Sync Script for Blocks
 *
 * From `https://blocks.so/r` Get all components and save them locally
 * Responsibility: Purely download, keep the source data as is
 *
 * Usage:
 *   bun run registries/blocks/scripts/sync.ts
 *   bun run registries/blocks/scripts/sync.ts --only=ai-01,hero-01
 *   bun run registries/blocks/scripts/sync.ts --dry-run
 */
