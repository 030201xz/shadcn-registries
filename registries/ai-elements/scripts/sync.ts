/**
 * Sync Script for AI Elements
 *
 * From `https://registry.ai-sdk.dev` Get all components and save them locally
 * Responsibility: Purely download, keep the source data as is
 *
 * Usage:
 *   bun run registries/ai-elements/scripts/sync.ts
 *   bun run registries/ai-elements/scripts/sync.ts --only=artifact,canvas
 *   bun run registries/ai-elements/scripts/sync.ts --dry-run
 */
